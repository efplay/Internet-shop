...
// Directory Page 
export function getDirectoryPage(){  //create html element to main page
    ...
    const mainTitle = getMainTitle("Directory") // we create main page in function getMainPage, but it create by other element
