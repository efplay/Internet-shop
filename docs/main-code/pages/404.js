...
export function getNotFoundPage(){  //create html element to main page
    ...
    const mainTitle = getMainTitle("Page Not Found") // we create main page in function getMainPage, but it create by other element
    //const desc = getDesc("Here is a processing of the order")  // we get the function and add to their string(text)

    

    page.append(mainTitle) // create the mainPage to our page
